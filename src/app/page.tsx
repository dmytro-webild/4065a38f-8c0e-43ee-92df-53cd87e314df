...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/adults-enjoying-mexican-food_23-2149663870.jpg",
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          price: "$3.00",
          variant: "Refreshing",
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-mexican-party-decoration-with-food_23-2149317344.jpg",
        },
        {
          id: "5",
        ...
        {
          id: "6",
          name: "House Made Salsas",
          price: "$2.00",
          variant: "Spicy",
          imageSrc: "http://img.b2bpic.net/free-photo/horizontal-view-potato-chips-spices-mayonnaise-with-ketchup-gray-table_140725-86848.jpg",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "We source the freshest local produce and meats for our daily specials.",
          imageSrc: "http://img.b2bpic.net/free-photo/vegetable-salad-with-mixed-ingredients-wooden-board_114579-56834.jpg",
        },
        {
          tag: "Authentic",
          title: "Traditional Recipes",
          subtitle: "Made with Love",
          description: "Our recipes are passed down through generations for an authentic taste.",
          imageSrc: "http://img.b2bpic.net/free-photo/mexican-ingredients_23-2148159743.jpg",
        },
        {
          tag: "Service",
          title: "Warm Welcoming",
          subtitle: "Best Service",
          description: "We treat every guest like part of the Tacos los panchos family.",
      ...
      faqs={[
        {
          ...
          content: "We are open daily for lunch and dinner to serve you fresh tacos.",
        },
        {
          id: "2",
          title: "Do you offer catering?",
          content: "Yes, contact us to discuss catering for your upcoming events.",
        },
        {
          id: "3",
          title: "Are you pet friendly?",
          content: "Our patio is pet friendly for our furry dining companions.",
        },
      ]}
